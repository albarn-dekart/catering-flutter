class ApiConfig {
  // static const String baseUrl = 'http://127.0.0.1:8000/api'; //PC
  // static const String baseUrl = 'http://10.0.2.2:8000/api';

  static const String baseUrl = 'http://3.74.155.130/api'; // prod
  ...
  static Uri changePassword() => Uri.parse('$baseUrl/user/change_password');

  static Uri userById(String id) => Uri.parse('$baseUrl/admin/user/$id');

  static Uri users() => Uri.parse('$baseUrl/admin/users');

  static Uri userDetailsById(String id) => Uri.parse('${userById(id)}/details');

  static Uri deleteUserById(String id) => Uri.parse('${userById(id)}/delete');
  ...
  static Uri ordersByUserId(String id) => Uri.parse('${userById(id)}/orders');
