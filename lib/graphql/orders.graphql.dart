                  ...
                  FieldNode(
                    ...
                    selectionSet: SelectionSetNode(
                      selections: [
                        ...
                        FieldNode(
                          name: NameNode(value: 'mealPlanName'),
                          alias: null,
                          arguments: [],
                          directives: [],
                          selectionSet: null,
                        ...
                        FieldNode(
                          name: NameNode(value: 'mealPlanPrice'),
                          alias: null,
                          arguments: [],
                          directives: [],
                          selectionSet: null,
                        ...
                        FieldNode(
                          name: NameNode(value: 'mealPlanCalories'),
                          alias: null,
                          arguments: [],
                          directives: [],
                          selectionSet: null,
                        ...
                        FieldNode(
                          name: NameNode(value: 'mealPlanProtein'),
                          alias: null,
                          arguments: [],
                          directives: [],
                          selectionSet: null,
                        ...
                        FieldNode(
                          name: NameNode(value: 'mealPlanFat'),
                          alias: null,
                          arguments: [],
                          directives: [],
                          selectionSet: null,
                        ...
                        FieldNode(
                          name: NameNode(value: 'mealPlanCarbs'),
                          alias: null,
                          arguments: [],
                          directives: [],
                          selectionSet: null,
                ...
                ObjectValueNode(
                  fields: [
                    ObjectFieldNode(
                      ...
                      value: StringValueNode(value: 'ASC', isBlock: false),
                    ),
                  ],
                ),
              ],
...
class Fragment$OrderSummary$orderItems$edges$node {
  ...
  factory Fragment$OrderSummary$orderItems$edges$node.fromJson(
    ...
    final l$mealPlanName = json['mealPlanName'];
    final l$mealPlanPrice = json['mealPlanPrice'];
    final l$mealPlanCalories = json['mealPlanCalories'];
    final l$mealPlanProtein = json['mealPlanProtein'];
    final l$mealPlanFat = json['mealPlanFat'];
    final l$mealPlanCarbs = json['mealPlanCarbs'];
    final l$mealPlan = json['mealPlan'];
    final l$$__typename = json['__typename'];
    return Fragment$OrderSummary$orderItems$edges$node(
      id: (l$id as String),
      quantity: (l$quantity as int),
      mealPlanName: (l$mealPlanName as String?),
      mealPlanPrice: (l$mealPlanPrice as int?),
      mealPlanCalories: (l$mealPlanCalories as num?)?.toDouble(),
      mealPlanProtein: (l$mealPlanProtein as num?)?.toDouble(),
      mealPlanFat: (l$mealPlanFat as num?)?.toDouble(),
      mealPlanCarbs: (l$mealPlanCarbs as num?)?.toDouble(),
      mealPlan: l$mealPlan == null
          ? null
          : Fragment$OrderSummary$orderItems$edges$node$mealPlan.fromJson(
  ...
  Map<String, dynamic> toJson() {
    ...
    _resultData['mealPlanName'] = l$mealPlanName;
    final l$mealPlanPrice = mealPlanPrice;
    _resultData['mealPlanPrice'] = l$mealPlanPrice;
    final l$mealPlanCalories = mealPlanCalories;
    _resultData['mealPlanCalories'] = l$mealPlanCalories;
    final l$mealPlanProtein = mealPlanProtein;
    _resultData['mealPlanProtein'] = l$mealPlanProtein;
    final l$mealPlanFat = mealPlanFat;
    _resultData['mealPlanFat'] = l$mealPlanFat;
    final l$mealPlanCarbs = mealPlanCarbs;
    _resultData['mealPlanCarbs'] = l$mealPlanCarbs;
...
class _CopyWithImpl$Fragment$OrderSummary$orderItems$edges$node<TRes>
  ...
  TRes call({
    ...
    Fragment$OrderSummary$orderItems$edges$node(
      ...
      quantity: quantity == _undefined || quantity == null
          ? _instance.quantity
          : (quantity as int),
      mealPlanName: mealPlanName == _undefined
          ? _instance.mealPlanName
          : (mealPlanName as String?),
      mealPlanPrice: mealPlanPrice == _undefined
          ? _instance.mealPlanPrice
          : (mealPlanPrice as int?),
      mealPlanCalories: mealPlanCalories == _undefined
          ? _instance.mealPlanCalories
          : (mealPlanCalories as double?),
      mealPlanProtein: mealPlanProtein == _undefined
          ? _instance.mealPlanProtein
          : (mealPlanProtein as double?),
      mealPlanFat: mealPlanFat == _undefined
          ? _instance.mealPlanFat
          : (mealPlanFat as double?),
      mealPlanCarbs: mealPlanCarbs == _undefined
          ? _instance.mealPlanCarbs
          : (mealPlanCarbs as double?),
  ...
  get mealPlan {
    ...
    return local$mealPlan == null
        ? CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan.stub(
            _then(_instance),
          )
...
class Fragment$OrderSummary$orderItems$edges$node$mealPlan {
  ...
  factory Fragment$OrderSummary$orderItems$edges$node$mealPlan.fromJson(
    ...
    return Fragment$OrderSummary$orderItems$edges$node$mealPlan(
      ...
      meals: l$meals == null
          ? null
          : Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals.fromJson(
  ...
  final Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals? meals;
...
> {
  ...
  TRes call({
    ...
    double? fat,
    double? carbs,
    Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals? meals,
    String? $__typename,
  });
  CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals<TRes>
  get meals;
}
...
class _CopyWithImpl$Fragment$OrderSummary$orderItems$edges$node$mealPlan<TRes>
  ...
  TRes call({
    ...
    Fragment$OrderSummary$orderItems$edges$node$mealPlan(
      ...
      meals: meals == _undefined
          ? _instance.meals
          : (meals
                as Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals?),
      $__typename: $__typename == _undefined || $__typename == null
          ? _instance.$__typename
          : ($__typename as String),
    ),
  ...
  get meals {
    ...
    return local$meals == null
        ? CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals.stub(
            _then(_instance),
          )
        : CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals(
            local$meals,
            (e) => call(meals: e),
          );
  }
...
class Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals {
  Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals({
    this.edges,
    this.$__typename = 'MealCursorConnection',
  });

  factory Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$edges = json['edges'];
    final l$$__typename = json['__typename'];
    return Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals(
      edges: (l$edges as List<dynamic>?)
          ?.map(
            (e) => e == null
                ? null
                : Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges.fromJson(
                    (e as Map<String, dynamic>),
                  ),
          )
          .toList(),
  ...
  final List<Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges?>?
  edges;
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$edges = edges;
...
extension UtilityExtension$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals
    on Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals {
  CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals<
    Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals
  >
  get copyWith =>
...
abstract class CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals<
  TRes
> {
  factory CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals(
    Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals instance,
    TRes Function(Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals)
    then,
  ) = _CopyWithImpl$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals;

  factory CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals.stub(
    TRes res,
  ) = _CopyWithStubImpl$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals;

  TRes call({
    List<Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges?>?
    edges,
    String? $__typename,
  });
  TRes edges(
    Iterable<Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges?>?
    Function(
      Iterable<
        CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges<
          Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges
        >?
      >?,
    )
    _fn,
...
class _CopyWithImpl$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals<
  TRes
>
    implements
        CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals<
  ...
  final Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals _instance;
...
class _CopyWithStubImpl$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals<
  TRes
>
    implements
        CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals<
...
class Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges {
  Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges({
    this.node,
    this.$__typename = 'MealEdge',
  });

  factory Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$node = json['node'];
    final l$$__typename = json['__typename'];
    return Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges(
      node: l$node == null
          ? null
          : Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node.fromJson(
              (l$node as Map<String, dynamic>),
            ),
      $__typename: (l$$__typename as String),
    );
  ...
  final Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node?
  node;
  ...
  bool operator ==(Object other) {
    ...
    if (other
            is! Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$node = node;
...
extension UtilityExtension$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges
    on Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges {
  CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges<
    Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges
  >
  get copyWith =>
...
abstract class CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges<
  TRes
> {
  factory CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges(
    Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges instance,
    TRes Function(
      Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges,
    )
    then,
  ) = _CopyWithImpl$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges;

  factory CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges.stub(
    TRes res,
  ) = _CopyWithStubImpl$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges;

  TRes call({
    Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node? node,
    String? $__typename,
  });
  CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node<
    TRes
  >
  get node;
}

class _CopyWithImpl$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges<
  TRes
>
    implements
        CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges<
  ...
  final Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges
  _instance;
  ...
  TRes call({
    ...
    Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges(
      node: node == _undefined
          ? _instance.node
          : (node
                as Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node?),
      $__typename: $__typename == _undefined || $__typename == null
          ? _instance.$__typename
          : ($__typename as String),
    ),
  ...
  get node {
    final local$node = _instance.node;
    return local$node == null
        ? CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node.stub(
            _then(_instance),
          )
        : CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node(
            local$node,
...
class _CopyWithStubImpl$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges<
  TRes
>
    implements
        CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges<
...
class Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node {
  Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node({
    required this.id,
    required this.name,
    required this.price,
  ...
  factory Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$id = json['id'];
    final l$name = json['name'];
    ...
    final l$carbs = json['carbs'];
    final l$$__typename = json['__typename'];
    return Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node(
      id: (l$id as String),
      name: (l$name as String),
      price: (l$price as int),
      calories: (l$calories as num).toDouble(),
  ...
  bool operator ==(Object other) {
    ...
    if (other
            is! Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$id = id;
...
extension UtilityExtension$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node
    on Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node {
  CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node<
    Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node
  >
  get copyWith =>
...
abstract class CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node<
  TRes
> {
  factory CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node(
    Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node
    instance,
    TRes Function(
      Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node,
    ...
    then,
  ) = _CopyWithImpl$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node;

  factory CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node.stub(
    TRes res,
  ) = _CopyWithStubImpl$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node;
...
class _CopyWithImpl$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node<
  TRes
>
    implements
        CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node<
...
class _CopyWithStubImpl$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node<
  TRes
>
    implements
        CopyWith$Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node<
...
class Fragment$OrderDetails$orderItems$edges$node
  ...
  factory Fragment$OrderDetails$orderItems$edges$node.fromJson(
    ...
    return Fragment$OrderDetails$orderItems$edges$node(
      ...
      mealPlan: l$mealPlan == null
          ? null
          : Fragment$OrderDetails$orderItems$edges$node$mealPlan.fromJson(
              (l$mealPlan as Map<String, dynamic>),
            ),
      $__typename: (l$$__typename as String),
    );
...
class _CopyWithImpl$Fragment$OrderDetails$orderItems$edges$node<TRes>
  ...
  get mealPlan {
    final local$mealPlan = _instance.mealPlan;
    return local$mealPlan == null
        ? CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan.stub(
            _then(_instance),
          )
...
class Fragment$OrderDetails$orderItems$edges$node$mealPlan
  ...
  factory Fragment$OrderDetails$orderItems$edges$node$mealPlan.fromJson(
    ...
    return Fragment$OrderDetails$orderItems$edges$node$mealPlan(
      ...
      meals: l$meals == null
          ? null
          : Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals.fromJson(
              (l$meals as Map<String, dynamic>),
            ),
      $__typename: (l$$__typename as String),
    );
  ...
  final Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals? meals;
...
> {
  ...
  TRes call({
    ...
    double? fat,
    double? carbs,
    Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals? meals,
    String? $__typename,
  });
  CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals<TRes>
  get meals;
}
...
class _CopyWithImpl$Fragment$OrderDetails$orderItems$edges$node$mealPlan<TRes>
  ...
  TRes call({
    ...
    Fragment$OrderDetails$orderItems$edges$node$mealPlan(
      ...
      meals: meals == _undefined
          ? _instance.meals
          : (meals
                as Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals?),
      $__typename: $__typename == _undefined || $__typename == null
          ? _instance.$__typename
          : ($__typename as String),
    ),
  ...
  get meals {
    final local$meals = _instance.meals;
    return local$meals == null
        ? CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals.stub(
            _then(_instance),
          )
        : CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals(
            local$meals,
            (e) => call(meals: e),
          );
  }
...
class Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals
    implements Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals {
  Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals({
    this.edges,
    this.$__typename = 'MealCursorConnection',
  });

  factory Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$edges = json['edges'];
    final l$$__typename = json['__typename'];
    return Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals(
      edges: (l$edges as List<dynamic>?)
          ?.map(
            (e) => e == null
                ? null
                : Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges.fromJson(
                    (e as Map<String, dynamic>),
                  ),
          )
          .toList(),
  ...
  final List<Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges?>?
  edges;
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$edges = edges;
...
extension UtilityExtension$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals
    on Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals {
  CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals<
    Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals
  >
  get copyWith =>
...
abstract class CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals<
  TRes
> {
  factory CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals(
    Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals instance,
    TRes Function(Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals)
    then,
  ) = _CopyWithImpl$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals;

  factory CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals.stub(
    TRes res,
  ) = _CopyWithStubImpl$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals;

  TRes call({
    List<Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges?>?
    edges,
    String? $__typename,
  });
  TRes edges(
    Iterable<Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges?>?
    Function(
      Iterable<
        CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges<
          Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges
        >?
      >?,
    )
    _fn,
...
class _CopyWithImpl$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals<
  TRes
>
    implements
        CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals<
  ...
  final Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals _instance;
...
class _CopyWithStubImpl$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals<
  TRes
>
    implements
        CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals<
...
class Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges
    implements
        Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges {
  Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges({
    this.node,
  ...
  factory Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$node = json['node'];
    final l$$__typename = json['__typename'];
    return Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges(
      node: l$node == null
          ? null
          : Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node.fromJson(
              (l$node as Map<String, dynamic>),
            ),
      $__typename: (l$$__typename as String),
    );
  ...
  final Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node?
  node;
  ...
  bool operator ==(Object other) {
    ...
    if (other
            is! Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$node = node;
...
extension UtilityExtension$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges
    on Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges {
  CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges<
    Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges
  >
  get copyWith =>
...
abstract class CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges<
  TRes
> {
  factory CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges(
    Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges instance,
    TRes Function(
      Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges,
    )
    then,
  ) = _CopyWithImpl$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges;

  factory CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges.stub(
    TRes res,
  ) = _CopyWithStubImpl$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges;

  TRes call({
    Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node? node,
    String? $__typename,
  });
  CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node<
    TRes
  >
  get node;
}

class _CopyWithImpl$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges<
  TRes
>
    implements
        CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges<
  ...
  final Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges
  _instance;
  ...
  TRes call({
    ...
    Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges(
      node: node == _undefined
          ? _instance.node
          : (node
                as Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node?),
      $__typename: $__typename == _undefined || $__typename == null
          ? _instance.$__typename
          : ($__typename as String),
    ),
  ...
  get node {
    final local$node = _instance.node;
    return local$node == null
        ? CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node.stub(
            _then(_instance),
          )
        : CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node(
            local$node,
...
class _CopyWithStubImpl$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges<
  TRes
>
    implements
        CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges<
...
class Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node
    implements
        Fragment$OrderSummary$orderItems$edges$node$mealPlan$meals$edges$node {
  Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node({
    required this.id,
    required this.name,
    required this.price,
    required this.calories,
  ...
  factory Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$id = json['id'];
    final l$name = json['name'];
    ...
    final l$carbs = json['carbs'];
    final l$$__typename = json['__typename'];
    return Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node(
      id: (l$id as String),
      name: (l$name as String),
      price: (l$price as int),
      calories: (l$calories as num).toDouble(),
  ...
  bool operator ==(Object other) {
    ...
    if (other
            is! Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$id = id;
...
extension UtilityExtension$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node
    on Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node {
  CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node<
    Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node
  >
  get copyWith =>
...
abstract class CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node<
  TRes
> {
  factory CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node(
    Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node
    instance,
    TRes Function(
      Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node,
    ...
    then,
  ) = _CopyWithImpl$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node;

  factory CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node.stub(
    TRes res,
  ) = _CopyWithStubImpl$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node;
...
class _CopyWithImpl$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node<
  TRes
>
    implements
        CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node<
...
class _CopyWithStubImpl$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node<
  TRes
>
    implements
        CopyWith$Fragment$OrderDetails$orderItems$edges$node$mealPlan$meals$edges$node<
...
class Variables$Query$GetOrders {
  factory Variables$Query$GetOrders({
    ...
    String? status,
    String? search,
    List<Input$OrderFilter_createdAt?>? createdAt,
  ...
  factory Variables$Query$GetOrders.fromJson(Map<String, dynamic> data) {
    ...
    if (data.containsKey('createdAt')) {
      ...
      result$data['createdAt'] = (l$createdAt as List<dynamic>?)
          ?.map(
            (e) => e == null
                ? null
                : Input$OrderFilter_createdAt.fromJson(
                    (e as Map<String, dynamic>),
                  ),
          )
          .toList();
  ...
  List<Input$OrderFilter_createdAt?>? get createdAt =>
      (_$data['createdAt'] as List<Input$OrderFilter_createdAt?>?);
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_$data.containsKey('createdAt')) {
      final l$createdAt = createdAt;
      result$data['createdAt'] = l$createdAt?.map((e) => e?.toJson()).toList();
    }
    return result$data;
  }
  ...
  bool operator ==(Object other) {
    ...
    if (l$createdAt != null && lOther$createdAt != null) {
      if (l$createdAt.length != lOther$createdAt.length) {
        return false;
      }
      for (int i = 0; i < l$createdAt.length; i++) {
        final l$createdAt$entry = l$createdAt[i];
        final lOther$createdAt$entry = lOther$createdAt[i];
        if (l$createdAt$entry != lOther$createdAt$entry) {
          return false;
        }
      }
    } else if (l$createdAt != lOther$createdAt) {
      return false;
    }
    return true;
  }
  ...
  int get hashCode {
    ...
    return Object.hashAll([
      ...
      _$data.containsKey('createdAt')
          ? l$createdAt == null
                ? null
                : Object.hashAll(l$createdAt.map((v) => v))
          : const {},
    ]);
  }
}
  ...
  TRes call({
    ...
    Variables$Query$GetOrders._({
      ...
      if (createdAt != _undefined)
        'createdAt': (createdAt as List<Input$OrderFilter_createdAt?>?),
    }),
  );
}
  ...
  definitions: [
    OperationDefinitionNode(
      ...
      variableDefinitions: [
        ...
        VariableDefinitionNode(
          variable: VariableNode(name: NameNode(value: 'createdAt')),
          type: ListTypeNode(
            type: NamedTypeNode(
              name: NameNode(value: 'OrderFilter_createdAt'),
              isNonNull: false,
            ),
            isNonNull: false,
          ),
        ...
        selections: [
          FieldNode(
            ...
            arguments: [
              ...
              ArgumentNode(
                name: NameNode(value: 'createdAt'),
                value: VariableNode(name: NameNode(value: 'createdAt')),
              ),
            ],
            directives: [],
            selectionSet: SelectionSetNode(
...
class Variables$Query$GetOrdersByRestaurant {
  factory Variables$Query$GetOrdersByRestaurant({
    ...
    String? search,
    List<Input$OrderFilter_createdAt?>? createdAt,
  }) => Variables$Query$GetOrdersByRestaurant._({
  ...
  Variables$Query$GetOrdersByRestaurant._(this._$data);

  factory Variables$Query$GetOrdersByRestaurant.fromJson(
    ...
    return Variables$Query$GetOrdersByRestaurant._(result$data);
  }
  ...
  CopyWith$Variables$Query$GetOrdersByRestaurant<
    Variables$Query$GetOrdersByRestaurant
  >
  get copyWith =>
      CopyWith$Variables$Query$GetOrdersByRestaurant(this, (i) => i);
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Variables$Query$GetOrdersByRestaurant ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$restaurantId = restaurantId;
...
abstract class CopyWith$Variables$Query$GetOrdersByRestaurant<TRes> {
  factory CopyWith$Variables$Query$GetOrdersByRestaurant(
    Variables$Query$GetOrdersByRestaurant instance,
    TRes Function(Variables$Query$GetOrdersByRestaurant) then,
  ) = _CopyWithImpl$Variables$Query$GetOrdersByRestaurant;

  factory CopyWith$Variables$Query$GetOrdersByRestaurant.stub(TRes res) =
      _CopyWithStubImpl$Variables$Query$GetOrdersByRestaurant;
...
class _CopyWithImpl$Variables$Query$GetOrdersByRestaurant<TRes>
    implements CopyWith$Variables$Query$GetOrdersByRestaurant<TRes> {
  _CopyWithImpl$Variables$Query$GetOrdersByRestaurant(
    this._instance,
    this._then,
  );

  final Variables$Query$GetOrdersByRestaurant _instance;

  final TRes Function(Variables$Query$GetOrdersByRestaurant) _then;
...
class _CopyWithStubImpl$Variables$Query$GetOrdersByRestaurant<TRes>
    implements CopyWith$Variables$Query$GetOrdersByRestaurant<TRes> {
  _CopyWithStubImpl$Variables$Query$GetOrdersByRestaurant(this._res);
...
class Query$GetOrdersByRestaurant {
  Query$GetOrdersByRestaurant({this.restaurant, this.$__typename = 'Query'});

  factory Query$GetOrdersByRestaurant.fromJson(Map<String, dynamic> json) {
    final l$restaurant = json['restaurant'];
    final l$$__typename = json['__typename'];
    return Query$GetOrdersByRestaurant(
      restaurant: l$restaurant == null
          ? null
          : Query$GetOrdersByRestaurant$restaurant.fromJson(
              (l$restaurant as Map<String, dynamic>),
            ),
      $__typename: (l$$__typename as String),
    );
  ...
  final Query$GetOrdersByRestaurant$restaurant? restaurant;
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Query$GetOrdersByRestaurant ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$restaurant = restaurant;
...
extension UtilityExtension$Query$GetOrdersByRestaurant
    on Query$GetOrdersByRestaurant {
  CopyWith$Query$GetOrdersByRestaurant<Query$GetOrdersByRestaurant>
  get copyWith => CopyWith$Query$GetOrdersByRestaurant(this, (i) => i);
}

abstract class CopyWith$Query$GetOrdersByRestaurant<TRes> {
  factory CopyWith$Query$GetOrdersByRestaurant(
    Query$GetOrdersByRestaurant instance,
    TRes Function(Query$GetOrdersByRestaurant) then,
  ) = _CopyWithImpl$Query$GetOrdersByRestaurant;

  factory CopyWith$Query$GetOrdersByRestaurant.stub(TRes res) =
      _CopyWithStubImpl$Query$GetOrdersByRestaurant;

  TRes call({
    Query$GetOrdersByRestaurant$restaurant? restaurant,
    String? $__typename,
  });
  CopyWith$Query$GetOrdersByRestaurant$restaurant<TRes> get restaurant;
}

class _CopyWithImpl$Query$GetOrdersByRestaurant<TRes>
    implements CopyWith$Query$GetOrdersByRestaurant<TRes> {
  _CopyWithImpl$Query$GetOrdersByRestaurant(this._instance, this._then);

  final Query$GetOrdersByRestaurant _instance;

  final TRes Function(Query$GetOrdersByRestaurant) _then;
  ...
  TRes call({
    ...
    Query$GetOrdersByRestaurant(
      restaurant: restaurant == _undefined
          ? _instance.restaurant
          : (restaurant as Query$GetOrdersByRestaurant$restaurant?),
      $__typename: $__typename == _undefined || $__typename == null
          ? _instance.$__typename
          : ($__typename as String),
    ),
  ...
  CopyWith$Query$GetOrdersByRestaurant$restaurant<TRes> get restaurant {
    final local$restaurant = _instance.restaurant;
    return local$restaurant == null
        ? CopyWith$Query$GetOrdersByRestaurant$restaurant.stub(_then(_instance))
        : CopyWith$Query$GetOrdersByRestaurant$restaurant(
            local$restaurant,
            (e) => call(restaurant: e),
          );
  }
...
class _CopyWithStubImpl$Query$GetOrdersByRestaurant<TRes>
    implements CopyWith$Query$GetOrdersByRestaurant<TRes> {
  _CopyWithStubImpl$Query$GetOrdersByRestaurant(this._res);
  ...
  CopyWith$Query$GetOrdersByRestaurant$restaurant<TRes> get restaurant =>
      CopyWith$Query$GetOrdersByRestaurant$restaurant.stub(_res);
}

const documentNodeQueryGetOrdersByRestaurant = DocumentNode(
  definitions: [
    OperationDefinitionNode(
      type: OperationType.query,
      name: NameNode(value: 'GetOrdersByRestaurant'),
      variableDefinitions: [
        VariableDefinitionNode(
...
Query$GetOrdersByRestaurant _parserFn$Query$GetOrdersByRestaurant(
  Map<String, dynamic> data,
) => Query$GetOrdersByRestaurant.fromJson(data);
typedef OnQueryComplete$Query$GetOrdersByRestaurant =
    FutureOr<void> Function(
      Map<String, dynamic>?,
      Query$GetOrdersByRestaurant?,
    );

class Options$Query$GetOrdersByRestaurant
    extends graphql.QueryOptions<Query$GetOrdersByRestaurant> {
  Options$Query$GetOrdersByRestaurant({
    String? operationName,
    required Variables$Query$GetOrdersByRestaurant variables,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
    graphql.CacheRereadPolicy? cacheRereadPolicy,
    Object? optimisticResult,
    Query$GetOrdersByRestaurant? typedOptimisticResult,
    Duration? pollInterval,
    graphql.Context? context,
    OnQueryComplete$Query$GetOrdersByRestaurant? onComplete,
    graphql.OnQueryError? onError,
  }) : onCompleteWithParsed = onComplete,
       super(
         variables: variables.toJson(),
         ...
         onComplete: onComplete == null
             ...
             : (data) => onComplete(
                 ...
                 data == null
                     ? null
                     : _parserFn$Query$GetOrdersByRestaurant(data),
               ),
         onError: onError,
         document: documentNodeQueryGetOrdersByRestaurant,
         parserFn: _parserFn$Query$GetOrdersByRestaurant,
       );

  final OnQueryComplete$Query$GetOrdersByRestaurant? onCompleteWithParsed;
...
class WatchOptions$Query$GetOrdersByRestaurant
    extends graphql.WatchQueryOptions<Query$GetOrdersByRestaurant> {
  WatchOptions$Query$GetOrdersByRestaurant({
    String? operationName,
    required Variables$Query$GetOrdersByRestaurant variables,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
...
class FetchMoreOptions$Query$GetOrdersByRestaurant
    extends graphql.FetchMoreOptions {
  FetchMoreOptions$Query$GetOrdersByRestaurant({
    required graphql.UpdateQuery updateQuery,
    required Variables$Query$GetOrdersByRestaurant variables,
  }) : super(
         updateQuery: updateQuery,
...
extension ClientExtension$Query$GetOrdersByRestaurant on graphql.GraphQLClient {
  Future<graphql.QueryResult<Query$GetOrdersByRestaurant>>
  query$GetOrdersByRestaurant(
    Options$Query$GetOrdersByRestaurant options,
  ) async => await this.query(options);

  graphql.ObservableQuery<Query$GetOrdersByRestaurant>
  watchQuery$GetOrdersByRestaurant(
    WatchOptions$Query$GetOrdersByRestaurant options,
  ) => this.watchQuery(options);

  void writeQuery$GetOrdersByRestaurant({
    required Query$GetOrdersByRestaurant data,
    required Variables$Query$GetOrdersByRestaurant variables,
    bool broadcast = true,
  }) => this.writeQuery(
    graphql.Request(
  ...
  Query$GetOrdersByRestaurant? readQuery$GetOrdersByRestaurant({
    required Variables$Query$GetOrdersByRestaurant variables,
    bool optimistic = true,
  }) {
    final result = this.readQuery(
    ...
    return result == null ? null : Query$GetOrdersByRestaurant.fromJson(result);
  }
}

graphql_flutter.QueryHookResult<Query$GetOrdersByRestaurant>
useQuery$GetOrdersByRestaurant(Options$Query$GetOrdersByRestaurant options) =>
    graphql_flutter.useQuery(options);
graphql.ObservableQuery<Query$GetOrdersByRestaurant>
useWatchQuery$GetOrdersByRestaurant(
  WatchOptions$Query$GetOrdersByRestaurant options,
) => graphql_flutter.useWatchQuery(options);

class Query$GetOrdersByRestaurant$Widget
    extends graphql_flutter.Query<Query$GetOrdersByRestaurant> {
  Query$GetOrdersByRestaurant$Widget({
    widgets.Key? key,
    required Options$Query$GetOrdersByRestaurant options,
    required graphql_flutter.QueryBuilder<Query$GetOrdersByRestaurant> builder,
  }) : super(key: key, options: options, builder: builder);
}

class Query$GetOrdersByRestaurant$restaurant {
  Query$GetOrdersByRestaurant$restaurant({
    required this.id,
    this.orders,
    this.$__typename = 'Restaurant',
  });

  factory Query$GetOrdersByRestaurant$restaurant.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$id = json['id'];
    final l$orders = json['orders'];
    final l$$__typename = json['__typename'];
    return Query$GetOrdersByRestaurant$restaurant(
      id: (l$id as String),
      orders: l$orders == null
          ? null
          : Query$GetOrdersByRestaurant$restaurant$orders.fromJson(
  ...
  final Query$GetOrdersByRestaurant$restaurant$orders? orders;
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Query$GetOrdersByRestaurant$restaurant ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$id = id;
...
extension UtilityExtension$Query$GetOrdersByRestaurant$restaurant
    on Query$GetOrdersByRestaurant$restaurant {
  CopyWith$Query$GetOrdersByRestaurant$restaurant<
    Query$GetOrdersByRestaurant$restaurant
  >
  get copyWith =>
      CopyWith$Query$GetOrdersByRestaurant$restaurant(this, (i) => i);
}

abstract class CopyWith$Query$GetOrdersByRestaurant$restaurant<TRes> {
  factory CopyWith$Query$GetOrdersByRestaurant$restaurant(
    Query$GetOrdersByRestaurant$restaurant instance,
    TRes Function(Query$GetOrdersByRestaurant$restaurant) then,
  ) = _CopyWithImpl$Query$GetOrdersByRestaurant$restaurant;

  factory CopyWith$Query$GetOrdersByRestaurant$restaurant.stub(TRes res) =
      _CopyWithStubImpl$Query$GetOrdersByRestaurant$restaurant;

  TRes call({
    String? id,
    Query$GetOrdersByRestaurant$restaurant$orders? orders,
    String? $__typename,
  });
  CopyWith$Query$GetOrdersByRestaurant$restaurant$orders<TRes> get orders;
}

class _CopyWithImpl$Query$GetOrdersByRestaurant$restaurant<TRes>
    implements CopyWith$Query$GetOrdersByRestaurant$restaurant<TRes> {
  _CopyWithImpl$Query$GetOrdersByRestaurant$restaurant(
    this._instance,
    this._then,
  );

  final Query$GetOrdersByRestaurant$restaurant _instance;

  final TRes Function(Query$GetOrdersByRestaurant$restaurant) _then;
  ...
  TRes call({
    ...
    Query$GetOrdersByRestaurant$restaurant(
      ...
      orders: orders == _undefined
          ? _instance.orders
          : (orders as Query$GetOrdersByRestaurant$restaurant$orders?),
      $__typename: $__typename == _undefined || $__typename == null
          ? _instance.$__typename
          : ($__typename as String),
    ),
  ...
  CopyWith$Query$GetOrdersByRestaurant$restaurant$orders<TRes> get orders {
    final local$orders = _instance.orders;
    return local$orders == null
        ? CopyWith$Query$GetOrdersByRestaurant$restaurant$orders.stub(
            _then(_instance),
          )
        : CopyWith$Query$GetOrdersByRestaurant$restaurant$orders(
            local$orders,
            (e) => call(orders: e),
          );
  }
...
class _CopyWithStubImpl$Query$GetOrdersByRestaurant$restaurant<TRes>
    implements CopyWith$Query$GetOrdersByRestaurant$restaurant<TRes> {
  _CopyWithStubImpl$Query$GetOrdersByRestaurant$restaurant(this._res);
  ...
  CopyWith$Query$GetOrdersByRestaurant$restaurant$orders<TRes> get orders =>
      CopyWith$Query$GetOrdersByRestaurant$restaurant$orders.stub(_res);
}

class Query$GetOrdersByRestaurant$restaurant$orders {
  Query$GetOrdersByRestaurant$restaurant$orders({
    this.edges,
    required this.pageInfo,
    this.$__typename = 'OrderCursorConnection',
  });

  factory Query$GetOrdersByRestaurant$restaurant$orders.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$edges = json['edges'];
    final l$pageInfo = json['pageInfo'];
    final l$$__typename = json['__typename'];
    return Query$GetOrdersByRestaurant$restaurant$orders(
      edges: (l$edges as List<dynamic>?)
          ?.map(
            (e) => e == null
                ? null
                : Query$GetOrdersByRestaurant$restaurant$orders$edges.fromJson(
                    (e as Map<String, dynamic>),
                  ),
          )
          .toList(),
      pageInfo: Query$GetOrdersByRestaurant$restaurant$orders$pageInfo.fromJson(
        (l$pageInfo as Map<String, dynamic>),
      ),
      $__typename: (l$$__typename as String),
    );
  ...
  final List<Query$GetOrdersByRestaurant$restaurant$orders$edges?>? edges;

  final Query$GetOrdersByRestaurant$restaurant$orders$pageInfo pageInfo;
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Query$GetOrdersByRestaurant$restaurant$orders ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$edges = edges;
...
extension UtilityExtension$Query$GetOrdersByRestaurant$restaurant$orders
    on Query$GetOrdersByRestaurant$restaurant$orders {
  CopyWith$Query$GetOrdersByRestaurant$restaurant$orders<
    Query$GetOrdersByRestaurant$restaurant$orders
  >
  get copyWith =>
      CopyWith$Query$GetOrdersByRestaurant$restaurant$orders(this, (i) => i);
}

abstract class CopyWith$Query$GetOrdersByRestaurant$restaurant$orders<TRes> {
  factory CopyWith$Query$GetOrdersByRestaurant$restaurant$orders(
    Query$GetOrdersByRestaurant$restaurant$orders instance,
    TRes Function(Query$GetOrdersByRestaurant$restaurant$orders) then,
  ) = _CopyWithImpl$Query$GetOrdersByRestaurant$restaurant$orders;

  factory CopyWith$Query$GetOrdersByRestaurant$restaurant$orders.stub(
    TRes res,
  ) = _CopyWithStubImpl$Query$GetOrdersByRestaurant$restaurant$orders;

  TRes call({
    List<Query$GetOrdersByRestaurant$restaurant$orders$edges?>? edges,
    Query$GetOrdersByRestaurant$restaurant$orders$pageInfo? pageInfo,
    String? $__typename,
  });
  TRes edges(
    Iterable<Query$GetOrdersByRestaurant$restaurant$orders$edges?>? Function(
      Iterable<
        CopyWith$Query$GetOrdersByRestaurant$restaurant$orders$edges<
          Query$GetOrdersByRestaurant$restaurant$orders$edges
        >?
      >?,
    )
    _fn,
  );
  CopyWith$Query$GetOrdersByRestaurant$restaurant$orders$pageInfo<TRes>
  get pageInfo;
}

class _CopyWithImpl$Query$GetOrdersByRestaurant$restaurant$orders<TRes>
    implements CopyWith$Query$GetOrdersByRestaurant$restaurant$orders<TRes> {
  _CopyWithImpl$Query$GetOrdersByRestaurant$restaurant$orders(
    this._instance,
    this._then,
  );

  final Query$GetOrdersByRestaurant$restaurant$orders _instance;

  final TRes Function(Query$GetOrdersByRestaurant$restaurant$orders) _then;
  ...
  TRes call({
    ...
    Query$GetOrdersByRestaurant$restaurant$orders(
      edges: edges == _undefined
          ? _instance.edges
          : (edges
                as List<Query$GetOrdersByRestaurant$restaurant$orders$edges?>?),
      pageInfo: pageInfo == _undefined || pageInfo == null
          ? _instance.pageInfo
          : (pageInfo
                as Query$GetOrdersByRestaurant$restaurant$orders$pageInfo),
      $__typename: $__typename == _undefined || $__typename == null
          ? _instance.$__typename
          : ($__typename as String),
    ),
  ...
  get pageInfo {
    final local$pageInfo = _instance.pageInfo;
    return CopyWith$Query$GetOrdersByRestaurant$restaurant$orders$pageInfo(
      local$pageInfo,
      (e) => call(pageInfo: e),
    );
  }
...
class _CopyWithStubImpl$Query$GetOrdersByRestaurant$restaurant$orders<TRes>
    implements CopyWith$Query$GetOrdersByRestaurant$restaurant$orders<TRes> {
  _CopyWithStubImpl$Query$GetOrdersByRestaurant$restaurant$orders(this._res);
  ...
  CopyWith$Query$GetOrdersByRestaurant$restaurant$orders$pageInfo<TRes>
  get pageInfo =>
      CopyWith$Query$GetOrdersByRestaurant$restaurant$orders$pageInfo.stub(
        _res,
      );
}

class Query$GetOrdersByRestaurant$restaurant$orders$edges {
  Query$GetOrdersByRestaurant$restaurant$orders$edges({
    this.node,
    this.$__typename = 'OrderEdge',
  });

  factory Query$GetOrdersByRestaurant$restaurant$orders$edges.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$node = json['node'];
    final l$$__typename = json['__typename'];
    return Query$GetOrdersByRestaurant$restaurant$orders$edges(
      node: l$node == null
          ? null
          : Fragment$OrderSummary.fromJson((l$node as Map<String, dynamic>)),
      $__typename: (l$$__typename as String),
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Query$GetOrdersByRestaurant$restaurant$orders$edges ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$node = node;
...
extension UtilityExtension$Query$GetOrdersByRestaurant$restaurant$orders$edges
    on Query$GetOrdersByRestaurant$restaurant$orders$edges {
  CopyWith$Query$GetOrdersByRestaurant$restaurant$orders$edges<
    Query$GetOrdersByRestaurant$restaurant$orders$edges
  >
  get copyWith => CopyWith$Query$GetOrdersByRestaurant$restaurant$orders$edges(
    this,
    (i) => i,
  );
}

abstract class CopyWith$Query$GetOrdersByRestaurant$restaurant$orders$edges<
  TRes
> {
  factory CopyWith$Query$GetOrdersByRestaurant$restaurant$orders$edges(
    Query$GetOrdersByRestaurant$restaurant$orders$edges instance,
    TRes Function(Query$GetOrdersByRestaurant$restaurant$orders$edges) then,
  ) = _CopyWithImpl$Query$GetOrdersByRestaurant$restaurant$orders$edges;

  factory CopyWith$Query$GetOrdersByRestaurant$restaurant$orders$edges.stub(
    TRes res,
  ) = _CopyWithStubImpl$Query$GetOrdersByRestaurant$restaurant$orders$edges;

  TRes call({Fragment$OrderSummary? node, String? $__typename});
  CopyWith$Fragment$OrderSummary<TRes> get node;
}

class _CopyWithImpl$Query$GetOrdersByRestaurant$restaurant$orders$edges<TRes>
    implements
        CopyWith$Query$GetOrdersByRestaurant$restaurant$orders$edges<TRes> {
  _CopyWithImpl$Query$GetOrdersByRestaurant$restaurant$orders$edges(
    this._instance,
    this._then,
  );

  final Query$GetOrdersByRestaurant$restaurant$orders$edges _instance;

  final TRes Function(Query$GetOrdersByRestaurant$restaurant$orders$edges)
  _then;
...
class _CopyWithStubImpl$Query$GetOrdersByRestaurant$restaurant$orders$edges<
  TRes
>
    implements
        CopyWith$Query$GetOrdersByRestaurant$restaurant$orders$edges<TRes> {
...
class Query$GetOrdersByRestaurant$restaurant$orders$pageInfo {
  Query$GetOrdersByRestaurant$restaurant$orders$pageInfo({
    required this.hasNextPage,
    this.endCursor,
    this.$__typename = 'OrderPageInfo',
  });

  factory Query$GetOrdersByRestaurant$restaurant$orders$pageInfo.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$hasNextPage = json['hasNextPage'];
    final l$endCursor = json['endCursor'];
    final l$$__typename = json['__typename'];
    return Query$GetOrdersByRestaurant$restaurant$orders$pageInfo(
      hasNextPage: (l$hasNextPage as bool),
      endCursor: (l$endCursor as String?),
      $__typename: (l$$__typename as String),
    );
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Query$GetOrdersByRestaurant$restaurant$orders$pageInfo ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$hasNextPage = hasNextPage;
...
extension UtilityExtension$Query$GetOrdersByRestaurant$restaurant$orders$pageInfo
    on Query$GetOrdersByRestaurant$restaurant$orders$pageInfo {
  CopyWith$Query$GetOrdersByRestaurant$restaurant$orders$pageInfo<
    Query$GetOrdersByRestaurant$restaurant$orders$pageInfo
  >
  get copyWith =>
      CopyWith$Query$GetOrdersByRestaurant$restaurant$orders$pageInfo(
...
abstract class CopyWith$Query$GetOrdersByRestaurant$restaurant$orders$pageInfo<
  TRes
> {
  factory CopyWith$Query$GetOrdersByRestaurant$restaurant$orders$pageInfo(
    Query$GetOrdersByRestaurant$restaurant$orders$pageInfo instance,
    TRes Function(Query$GetOrdersByRestaurant$restaurant$orders$pageInfo) then,
  ) = _CopyWithImpl$Query$GetOrdersByRestaurant$restaurant$orders$pageInfo;

  factory CopyWith$Query$GetOrdersByRestaurant$restaurant$orders$pageInfo.stub(
    TRes res,
  ) = _CopyWithStubImpl$Query$GetOrdersByRestaurant$restaurant$orders$pageInfo;

  TRes call({bool? hasNextPage, String? endCursor, String? $__typename});
}

class _CopyWithImpl$Query$GetOrdersByRestaurant$restaurant$orders$pageInfo<TRes>
    implements
        CopyWith$Query$GetOrdersByRestaurant$restaurant$orders$pageInfo<TRes> {
  _CopyWithImpl$Query$GetOrdersByRestaurant$restaurant$orders$pageInfo(
    this._instance,
  ...
  final Query$GetOrdersByRestaurant$restaurant$orders$pageInfo _instance;

  final TRes Function(Query$GetOrdersByRestaurant$restaurant$orders$pageInfo)
  _then;
...
class _CopyWithStubImpl$Query$GetOrdersByRestaurant$restaurant$orders$pageInfo<
  TRes
>
    implements
        CopyWith$Query$GetOrdersByRestaurant$restaurant$orders$pageInfo<TRes> {
...
abstract class CopyWith$Variables$Query$GetUserOrders<TRes> {
  ...
  TRes call({String? id, int? first, String? after, String? status});
}
...
class _CopyWithStubImpl$Variables$Query$GetUserOrders<TRes>
  ...
  call({String? id, int? first, String? after, String? status}) => _res;
}
